  ...
  if (!isConnected) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-gray-400 mb-6">Connect your wallet to interact with the BaseLots token</p>
        <button
          onClick={() => connect({ connector: injected() })}
          className="bg-gradient-to-r from-cyan-500 to-orange-500 text-white px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity"
        >
          Connect Wallet
        </button>
      </div>
